...
/// <summary> This class is used to handle the changelog for the FFStreamViewer plugin. </summary>
public class FFStreamViewerChangelog
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FFStreamViewerChangelog"/> class.
    /// <list type="bullet">
    ...
    private static void Add0_9_9_10(Changelog log)
        => log.NextVersion("Version 1.0.1.2 Pre-Release")
            ...
            .RegisterHighlight("Debug Menu moved to /FFStreamViewer debug , will no longer show up in config menu.");
