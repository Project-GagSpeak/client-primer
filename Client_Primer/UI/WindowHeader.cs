...
namespace FFStreamViewer.UI.Tabs;
...
public static class WindowHeader
{
    public struct Button {
        ...
        /// <summary> This function draws the button. </summary>
    ...
    /// <summary> This function draws the header for the window. (the fancy label at the top of each tab's window you see "Whitelist Manager" ext.)
    /// <list type="bullet">
