...
public class BackupService
{
    ...
    public BackupService(Logger logger, FilenameService fileNames) {
        _logger          = logger;
        _fileNames       = FFStreamViewerFiles(fileNames);
    ...
    /// <summary> Collect all relevant files for FFStreamViewer configuration. </summary>
    private static IReadOnlyList<FileInfo> FFStreamViewerFiles(FilenameService fileNames) {
