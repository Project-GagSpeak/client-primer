...
public sealed class GlamourChangedService : DisposableMediatorSubscriberBase
{
    ...
    public GlamourChangedService(ILogger<CacheCreationService> logger, GagspeakMediator mediator,
