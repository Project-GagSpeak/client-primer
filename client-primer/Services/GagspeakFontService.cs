...
{
    private readonly ILogger<CustomFontService> _logger;
    private readonly IDalamudPluginInterface PluginInterface;     // used to get the plugin interface
    
    public readonly IFontHandle GagSpeakFont;
    
    public CustomFontService(ILogger<CustomFontService> logger,
        IDalamudPluginInterface pluginInterface)
    {
        PluginInterface = pluginInterface;

        var gagspeakFontFile = Path.Combine(PluginInterface.AssemblyLocation.Directory?.FullName!, "DoulosSIL-Regular.ttf");
        if (File.Exists(gagspeakFontFile))
        {
            ...
            GagSpeakFont = PluginInterface.UiBuilder.FontAtlas.NewDelegateFontHandle(
                e => e.OnPreBuild(
