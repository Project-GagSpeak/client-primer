...
namespace GagSpeak.Toybox.Patterns;

/// <summary>
/// This class manages displaying the playback of a pattern onto a visual display. This could be a vibe remote, or other form of interface UI.
/// </summary>
...
#region Helper Fuctions
    ...
    public void StartPlayback(PatternData pattern, int IdxToPlay) {
        _logger.LogDebug($"Starting playback of pattern {pattern._name}");
    ...
    public void StopPlayback() {
        _logger.LogDebug($"Stopping playback of pattern {_tempStoredPattern._name}");
    ...
    private void ReadVibePosFromBuffer(object? sender, ElapsedEventArgs e) {
        ...
        if (_isPlaybackActive) {
            ...
            //_logger.LogDebug($"Playing back position {_playbackIndex} with data {storedRecordedPositions[_playbackIndex]}");
