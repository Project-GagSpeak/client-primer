...
public class CustomFilterComboColors : CustomFilterComboCache<KeyValuePair<byte, (string Name, uint Color, bool Gloss)>>
{
    ...
    public CustomFilterComboColors(float comboWidth, MouseWheelType allowMouseWheel,
