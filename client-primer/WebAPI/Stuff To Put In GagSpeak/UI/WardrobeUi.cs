...
/// <summary>
/// Intended to be an additional window popout, fancified visual for wardrobe configuration.
/// 
/// This can be opened from the wardrobe button in the main UI homepage tab.
/// </summary>
public class WardrobeUi : WindowMediatorSubscriberBase
{
    ...
    public WardrobeUi(ILogger<EditProfileUi> logger, GagspeakMediator mediator,
